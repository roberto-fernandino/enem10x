...
def Recupera_questoes_enem(
    ...
    for pagina, texto in pag_conteudo.items():
        ...
        if (
            f"CN - 1º dia I Caderno 3 - BRANCO - Página" in questoes[counter]
            or f"CH - 1º dia I Caderno 3 - BRANCO - Página" in questoes[counter]
        ):
...
Recupera_questoes_enem(
    "/home/roberto/projects/enem10x/src/leitor_pdf/Enem_2012_dia1.pdf"
)
