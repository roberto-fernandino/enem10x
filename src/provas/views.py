...
from materiais.models import Questao, Materia, SubMateria, Conteudo, ProvaCompleta, ProvaRespondida, Nivel, Simulado, QuestaoRespondida
from provas.forms import ProvaChoose
from django.contrib.auth.decorators import login_required
from django.urls import reverse
from usuarios.funcs import filtra_questoes_feitas
from math import floor
from provas.funcs import filtra_questoes_simulado_linguagens, filtra_questoes_simulado_natureza, filtra_questoes_simulado_matematica
        ...
        if choose_prova.is_valid():
            ...
            if tipo_prova == 'simulado':
                ...
                for simulado in simulados:
                    ...
                    if len(materia_in_simulado) == 1 and materia_in_simulado[0].nome == "Matematica":
        ...
        if tipo_prova == 'simulado':
            ...
            for simulado in simulados:
                ...
                for questao_id, resposta in request.POST.items():
                    if 'questao_id-' in questao_id:
                        real_questao_id  = questao_id.split('-')[1]
                        questao =  Questao.objects.filter(pk=real_questao_id)
                        prova_respondida_obj = ProvaRespondida.objects.create(
                            usuario=request.user,
                            questao=questao,
                            resposta=resposta,
