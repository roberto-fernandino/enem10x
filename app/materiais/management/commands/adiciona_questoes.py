    ...
    def handle(self, *args, **kwargs):
        ...
        if materia:
            try:
                ...
                self.stdout.write(self.style.ERROR(f'Erro: arquivo {arquivo} nao encontrado na pasta "/app/leitores", certifique-se de que os arquivos pra extração estão presentes nesta pasta.'))
        else:   
